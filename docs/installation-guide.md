...
2. `dist/home-device-iot-dashboard-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md` を取得する。
3. repo を clone する。

```powershell
git clone https://github.com/Sunmax0731/home-device-iot-dashboard.git
cd home-device-iot-dashboard
